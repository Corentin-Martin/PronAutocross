            ...
            <tbody>
                <?php if (!empty($players)) : ?>
                    <?php foreach ($players as $player) : ; ?>
                        ...
                        <?php if (isset($_SESSION['user']) && isset($friends)) { foreach ($friends as $friend) { if ($friend->getPseudo() === $player['fiche']->getPseudo()) { echo 'class="table-light"';}}} ?> <?= ($player['place'] == 1) ? 'class="table-success"' : "" ?> >
