...
<div class="row mt-3 m-auto align-items-center">
        <div class="col-12 col-sm-8">
            ...
            <article class="bg-light rounded-3 mb-2 p-2 shadow lh-1" style="--bs-bg-opacity: .7;">
                ...
                <p>Mis à part les côtes, tout le reste de l'expérience va changer et <span class="text-decoration-underline">être simplifiée</span> !</p>
        ...
        <div class="col-12 col-sm-4">
            ...
            <div> 
                <table class="table  table-light table-hover table-striped shadow align-middle">
                    <thead>
                        <tr>
                            <th colspan="3">Dernière épreuve : <?= $race->getName() ?></th>
                        </tr>
                        <th>Place</th>
                        <th>Pseudo</th>
                        <th>Total</th>
