    ...
    <div class="col-12">
        <form action="" method="post">
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="firstName"> Prénom
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="lastName"> Nom de famille
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="number"> Numéro
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="vehicle"> Véhicule
                    <input type="text" class="form-control" name="vehicle" id="vehicle" placeholder="Véhicule" <?= ($driver) ? "value = \" {$driver->getVehicle()} \"" : "" ?>required>
                </label>
            </div>
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="picture"> Photo
                    <input type="file" class="form-control" name="picture" id="picture" accept="image/png, image/jpg">
                </label>
            </div>
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="category"> Catégorie
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="status"> Statut
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="place"> Position au championnat
                    <input type="place" class="form-control" name="place" id="place" placeholder="Place" <?= ($driver) ? "value = \"{$driver->getPlace()}\"" : "value=\"0\"" ?>required>
                </label>
            </div>
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="rate1"> Cote 1
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="rate2"> Cote 2
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="overall"> Cote affinée
