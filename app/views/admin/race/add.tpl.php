    ...
    <div class="col-12">
        <form action="" method="post">
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="year">
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="name">Nom de l'épreuve
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="date">Date
            ...
            <div class="form-group">
                <label class="col-8 text-primary fw-bold shadow border border-primary p-2 mt-2" for="poster">Poster
